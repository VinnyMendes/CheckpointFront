...
function divMaker(text){
    ...
    btn.setAttribute("style", "position: absolute; top: 0; right: 0; font-size: 2rem; background: transparent; padding: 1rem 2rem")
...
function delFlashcards(){
    let confirmation = confirm("Do you really want to delete all your moviecards?")
    if(!confirmation){
        return
    }
